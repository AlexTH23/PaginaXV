...
<head>
    <meta charset="utf-8">
    <title>Testimonial - Miriams´S Coreography</title>
...
<body>
      ...
      <div class="p-4" style="background: rgba(51, 33, 29, .85); border-radius: 10px;">
        ...
        <form action="https://formsubmit.co/villanuevajovana1@gmail.com" method="POST" id="formTestimonio">
          ...
          <div class="form-group mb-2">
            ...
            <input type="text" name="name" id="testimonialNombre" class="form-control" placeholder="Escribe tu nombre">
          </div>

          <div class="form-group mb-3">
            <label class="text-white">Comentario</label>
            <textarea name="comentario" id="testimonialComentario" class="form-control" rows="4" placeholder="Escribe tu comentario aquí..." required></textarea>
          </div>
    ...
    <script>
      (function(){
        const anonCheck = document.getElementById('testimonialAnonCheck');
        const nombreInput = document.getElementById('testimonialNombre');
        ...
        anonCheck.addEventListener('change', function() {
          if (this.checked) {
            ...
            nombreInput.setAttribute('placeholder', 'Anónimo');
          } else {
            nombreInput.disabled = false;
        ...
        document.getElementById('formTestimonio').addEventListener('submit', function(e){
          if (anonCheck.checked) {
            const nm = this.querySelector('input[name="name"]');
            if (nm) nm.parentNode.removeChild(nm);
          }
        });
      })();
    </script>
